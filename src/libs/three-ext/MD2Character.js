THREE.MD2CharacterCache = {
        ...
        loadJson: function ( url, callback) {
                ...
                if ( this.cache[ url ] !== undefined ) {
                        ...
                        this.jsonLoader.load( url, function ( geo ) {
...
THREE.MD2Character = function () {
        ...
        this.loadParts = function ( config ) {
                ...
                THREE.MD2CharacterCache.loadJson( config.baseUrl + config.body, function( geo ) {
                ...
                for ( var i = 0; i < config.weapons.length; i ++ ) {
                        ...
                        THREE.MD2CharacterCache.loadJson( config.baseUrl + config.weapons[ i ][ 0 ],
        ...
        function loadTextures( baseUrl, textureUrls ) {
                ...
                for ( var i = 0; i < textureUrls.length; i ++ ) {
                        ...
                        textures[ i ] = THREE.MD2CharacterCache.loadTexture( baseUrl + textureUrls[ i ],
                          mapping, checkLoadingComplete );
        ...
        function checkLoadingComplete() {
                ...
                if ( scope.loadCounter === 0 ) scope.onLoadComplete(root);
